...
export class ChartComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.service.getTimes().subscribe((res: any) => {
      ...
      this.multi[0].series = this.service.getDayInTheWorld(this.arr,this.confirm,this.multi[0].name)
      this.multi[1].series = this.service.getDayInTheWorld(this.arr, this.confirm, this.multi[1].name)
      this.multi[2].series = this.service.getDayInTheWorld(this.arr, this.confirm, this.multi[2].name)
